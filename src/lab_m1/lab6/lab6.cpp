...
void Lab6::Update(float deltaTimeSeconds)
{
    ...
    int loc_time = glGetUniformLocation(shaders["LabShader"]->program, "Time");
...
void Lab6::RenderSimpleMesh(Mesh* mesh, Shader* shader, const glm::mat4& modelMatrix)
{
    ...
    loc_model_matrix = glGetUniformLocation(shader->program, "View");
    // TODO(student): Set shader uniform "View" to viewMatrix
    glm::mat4 viewMatrix = GetSceneCamera()->GetViewMatrix();
    glUniformMatrix4fv(loc_model_matrix, 1, GL_FALSE, glm::value_ptr(viewMatrix));

    // TODO(student): Get shader location for uniform mat4 "Projection"
    loc_model_matrix = glGetUniformLocation(shader->program, "Projection");

    // TODO(student): Set shader uniform "Projection" to projectionMatrix
    glm::mat4 projectionMatrix = GetSceneCamera()->GetProjectionMatrix();
    glUniformMatrix4fv(loc_model_matrix, 1, GL_FALSE, glm::value_ptr(projectionMatrix));
