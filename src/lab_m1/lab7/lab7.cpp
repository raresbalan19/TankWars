...
void Lab7::Update(float deltaTimeSeconds)
{
    ...
    // Render ground
    {
        ...
        RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix, groundColor);
    }
...
void Lab7::RenderSimpleMesh(Mesh* mesh, Shader* shader, const glm::mat4& modelMatrix, const glm::vec3& color)
{
    ...
    glUniform1f(glGetUniformLocation(shader->program, "warp_radius"), warpRadius);
    glUniform1f(glGetUniformLocation(shader->program, "warp_strength"), warpStrength);
